    ...
    <div class="container py-5">
        <div class="row align-items-center py-4">
            <div class="col-md-6 text-center text-md-left">
                <h3 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase">post o'zgartirish</h3>
            </div>
                ...
                <div class="contact-form">
                    ...
                    <form action="{{route('posts.update',$post)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class=" control-group">
                            <input value="{{$post->title}}" type="text" name="title" class="form-control p-4" id="name" placeholder="post title"  data-validation-required-message="Please enter your name" aria-invalid="false">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class=" control-group">
                            <input type="file" name="photo" class="form-control p-4" id="email" placeholder=""  data-validation-required-message="Please enter your email">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input value="{{$post->short_content}}" name="short_content" type="text" class="form-control p-4" id="subject" placeholder="qisqa malumot" data-validation-required-message="Please enter a subject">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea name="content" class="form-control p-4" rows="6" id="message" placeholder="malumot"  data-validation-required-message="Please enter your message">{{$post->content}}</textarea>
                            <p class="help-block texlt-danger"></p>
                        </div>
                        <div>
                            <button class="btn btn-primary btn-block py-3 px-5" type="submit" id="sendMessageButton">Update</button>
                        </div>
                    </form>
                </div>
            </div>
